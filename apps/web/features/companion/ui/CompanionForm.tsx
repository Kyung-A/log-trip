            ...
            <label className="flex justify-between w-full px-4 py-3 border-b border-gray-300">
              ...
              >
                <Picker.Column name="companion_count">
                  {detailData
                    ? Array.from(
                        { length: 7 - detailData.companion_count },
                        (_, i) => (
                          <Picker.Item
                            key={detailData.companion_count + i}
                            value={detailData.companion_count + i}
                            style={{ fontSize: 18 }}
                          >
          ...
          render={({ field: { onChange, value } }) => (
            <label className="flex justify-between w-full px-4 py-3 border-b border-gray-300">
              ...
              <Picker
                ...
                height={30}
                className={`text-gray-500 ${
                  !!detailData ? "pointer-events-none" : ""
                }`}
              >
