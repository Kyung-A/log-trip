      ...
      <form onSubmit={handleSubmit(onSubmit)} className="px-4 py-4 space-y-4">
        <div>
          ...
          <input
            ...
            placeholder="일정 제목"
            className="w-full border border-zinc-300 rounded-lg px-3 py-2 text-sm outline-none focus:border-latte"
          />
          {errors.title && (
        ...
        <div>
          ...
          <textarea
            ...
            placeholder="메모 (선택)"
            rows={3}
            className="w-full border border-zinc-300 rounded-lg px-3 py-2 text-sm outline-none focus:border-latte resize-none"
          />
        </div>
